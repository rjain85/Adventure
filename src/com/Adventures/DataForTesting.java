...
// This class was taken from the class Professor Evans wrote for us for MP 2.
...
public class DataForTesting {
    ...
    public static String getFileContentsAsString(String filename) {
        ...
        // In this case, we're looking for files that ar e in a directory called 'data' located in the
